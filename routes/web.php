...
Route::group(['middleware' => ['auth', 'verified']], function () {
    ...
    Route::get('Pending-Order', [AppsController::class, 'PendingOrders'])->name('Pending-Order');
    Route::get('Hold-Order', [AppsController::class, 'HoldOrders'])->name('Hold-Order');
    Route::get('Cancel-Order', [AppsController::class, 'CancelOrders'])->name('Cancel-Order');
    Route::get('Confrim-Order', [AppsController::class, 'ConfrimOrders'])->name('Confrim-Order');
    Route::get('Processing-Order', [AppsController::class, 'ProcessingOrders'])->name('Processing-Order');
    Route::get('Delivered-Order', [AppsController::class, 'DeliveredOrders'])->name('Delivered-Order');
    Route::get('Return-Order', [AppsController::class, 'ReturnOrders'])->name('Return-Order');
    Route::get('Expanse', [AppsController::class, 'Expanses'])->name('Expanse');
    Route::get('Expense-Catagory', [AppsController::class, 'ExpenseCatagorys'])->name('Expense-Catagory');
    Route::get('Product', [AppsController::class, 'Products'])->name('Product');
    Route::get('Customer', [AppsController::class, 'Customers'])->name('Customer');
    Route::get('Account', [AppsController::class, 'Accounts'])->name('Account');
