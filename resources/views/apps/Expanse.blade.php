        ...
        <div class=" space-y-5">
            ...
            <div class="card">
                <div class="flex items-center  p-4">
                    ...
                    <div class="mr-4">
                        <label class="mb-2" for="Resignation-field" > Search</label>
                        <input type="text" placeholder="Search" id="datepicker" class=" form-input px-4 py-2 leading-tight border-gray-300 rounded-md focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 focus:outline-none">
                    </div>
                    ...
                    <div class="col-lg-2 w-48 mr-4" >
                        <label class="mb-2" for="Resignation-field" > Payment*</label>
                        <select class="form-control" data-plugin="choices"
                            data-choices data-choices-search-false
                            name="choices-single-default" id="idStatus">
                      ...
                      <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700 data-table">
                        ...
                        <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                            ...
                            <tr>
                              ...
                              <td class="table-td ">Advance Salary
                            </td>
                              <td class="table-td ">3/26/2022</td>
                              <td class="table-td ">20.12.2022</td>
                              <td class="table-td ">
                                ...
                                <div class="inline-block px-3 min-w-[90px] text-center mx-auto py-1 rounded-[999px] bg-opacity-25 text-red-500
                                    bg-red-500">
                                    Unpaid
                                </div>
