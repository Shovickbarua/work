...
<div class="sidebar-wrapper group w-0 hidden xl:w-[248px] xl:block">
    ...
    <div class="sidebar-menus bg-white dark:bg-slate-800 py-2 px-4 h-[calc(100%-80px)] z-50" id="sidebar_menus">
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="{{ route('dashboards.analytic') }}" class="navItem {{ (\Request::route()->getName() == 'dashboards') ? 'active' : '' }}">
            ...
            <li class="{{ (\Request::route()->getName() == 'project*') ? 'active' : '' }}">
                ...
                <a href="{{ route('Product') }}" class="navItem {{ (\Request::route()->getName() == 'Products') ? 'active' : '' }}">
                    <span class="flex items-center">
                        <iconify-icon class=" nav-icon" icon="fluent-mdl2:product"></iconify-icon>
            ...
            <li class="{{ (\Request::route()->getName() == 'project*') ? 'active' : '' }}">
                ...
                <a href="{{ route('Customer') }}" class="navItem {{ (\Request::route()->getName() == 'Customers') ? 'active' : '' }}">
                    <span class="flex items-center">
            ...
            <li class="{{ (\Request::route()->getName() == 'project*') ? 'active' : '' }}">
                <a href="javascript:void(0)" class="navItem">
                    <span class="flex items-center">
                        <iconify-icon class=" nav-icon" icon="mdi:order-bool-ascending"></iconify-icon>
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="{{ route('Pending-Order') }}" class="{{ (\Request::route()->getName() == 'PendingOrders') ? 'active' : '' }}">{{ __('Pending Order') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('Confrim-Order') }}" class="{{ (\Request::route()->getName() == 'ConfrimDetails') ? 'active' : '' }}">{{ __('Confrim Order') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('Processing-Order') }}" class="{{ (\Request::route()->getName() == 'ProcessingDetails') ? 'active' : '' }}">{{ __('Processing Order') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('Hold-Order') }}" class="{{ (\Request::route()->getName() == 'HoldOrders') ? 'active' : '' }}">{{ __('IN Transit') }}</a>
                    </li>

                    <li>
                        <a href="{{ route('Delivered-Order') }}" class="{{ (\Request::route()->getName() == 'DeliveredDetails') ? 'active' : '' }}">{{ __('Delivered Order') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('Cancel-Order') }}" class="{{ (\Request::route()->getName() == 'CancelDetails') ? 'active' : '' }}">{{ __('Cancel Order') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('Return-Order') }}" class="{{ (\Request::route()->getName() == 'ReturnDetails') ? 'active' : '' }}">{{ __('Return Order') }}</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="{{ (\Request::route()->getName() == 'project*') ? 'active' : '' }}">
                <a href="javascript:void(0)" class="navItem">
                    <span class="flex items-center">
                        <iconify-icon class=" nav-icon" icon="mdi:cash"></iconify-icon>
                        <span>{{ __('Expanse') }}</span>
                    </span>
                    <iconify-icon class="icon-arrow" icon="heroicons-outline:chevron-right"></iconify-icon>
                </a>
                <ul class="sidebar-submenu">
                    <li>
                        <a href="{{ route('Expense-Catagory') }}" class="{{ (\Request::route()->getName() == 'ExpenseCatagorys') ? 'active' : '' }}">{{ __('Expense Catagory') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('Expanse') }}" class="{{ (\Request::route()->getName() == 'Expanses') ? 'active' : '' }}">{{ __('Expanse') }}</a>
                    </li>
                    <li>
                        <a href="{{ route('Account') }}" class="{{ (\Request::route()->getName() == 'Accounts') ? 'active' : '' }}">{{ __('Account') }}</a>
                    </li>
